...
class Integration(Base):
    ...
    wa_phone_number_id = Column(String, nullable=False, index=True)
    wa_access_token = Column(Text, nullable=False)  # Armazenar encriptado no futuro
    wa_business_account_id = Column(String, nullable=True)
    is_active = Column(Boolean, default=True)
    ...
    # Relationships
    user = relationship("User", backref="integration")
