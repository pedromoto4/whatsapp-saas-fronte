...
import { CheckIcon, DotIcon, BarChartIcon, SettingsIcon } from '@phosphor-icons/react'
...
export default function LandingPage() {
  ...
  const features = [
    {
      icon: <DotIcon size={48} className="text-primary" />,
    ...
    {
      icon: <SettingsIcon size={48} className="text-primary" />,
